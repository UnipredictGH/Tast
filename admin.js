...
c6.appendChild(btn(“Copy”,“btn-gh btn-sm”,function(pid){return function(){var p=_progs.find(function(x){return x.id===pid;});if(p){var c=Object.assign({},p);delete c.id;delete c.created_at;delete c.updated_at;c.name=p.name+” (Copy)”;progMd(null,c);}};}(p.id)));c6.appendChild(sp());
