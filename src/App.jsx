...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Outfit:wght@700;800;900&display=swap'); *{box-sizing:border-box;-webkit-tap-highlight-color:rgba(0,0,0,0)} html,body{overflow-x:hidden;max-width:100vw;margin:0;padding:0} .scrollbar-hide{-ms-overflow-style:none;scrollbar-width:none} .scrollbar-hide::-webkit-scrollbar{display:none} @keyframes ticker{from{transform:translateX(0)}to{transform:translateX(-50%)}} input,select,textarea,button{font-family:Inter,Arial,sans-serif;-webkit-appearance:none;appearance:none} button{touch-action:manipulation;cursor:pointer;user-select:none;border:none;background:none;padding:0} input:focus,select:focus,textarea:focus{outline:none} ${showSticky ? "body{padding-bottom:56px}" : ""}`}</style>
